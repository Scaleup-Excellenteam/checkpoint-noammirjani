/**
 *   This program manage a school database.
 *   It can add, delete, update, and print students.
 *   It can also backup the database to a file, and restore it from a file.
 *
...
void initDB(){
    ...
    while (fread(&ciphertext_len, sizeof(int), 1, encryptedFile) > 0) {
        ...
        parseStudentFromFileLine((char*)decryptedText);
    }
